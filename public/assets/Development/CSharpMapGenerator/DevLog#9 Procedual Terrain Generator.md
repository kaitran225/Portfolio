# DevLog#9 Procedual Terrain Generator
...
public static class BioDistributionGenerator
{
    ...
    private static Color[] CreateBiomeColorMap(int width, int height, Vector2[,] bioDistribution, Color[] biomesMap, float[,] noiseMap, Gradient ocean, float waterLevel,bool useFallOff,float[,] fallOffMap)
    {
        ...
        for (int y = 0; y < height; y++)
        {
            for (int x = 0; x < width; x++)
            { 
                int currentX = Mathf.Clamp((int)((float)bioDistribution[x, y].x * width), 0, width);
                int currentY = Mathf.Clamp((int)((float)bioDistribution[x, y].y * height), 0, height);
                ...
                Color currentColor = biomesMap[currentY * width + currentX];
                currentColor = new(currentColor.r - a, currentColor.g - a, currentColor.b - a,1);
...
public class MapGenerator : MonoBehaviour
{
    ...
    public enum DrawMode { NoiseMap, BioGradientColorRange, BiomeDistributionMap }
    [Header("Basic")]
...
```csharp
 /// <summary>
    /// This function re-create map using set data of index-nth data saved in SavedTerrain
    /// </summary>
    ...
    /// <summary>
    /// This function save terrain data into CACHE
    /// </summary>
    ...
    /// <summary>
    /// This function create a grayscale value gradient
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// This function create a gradient using data from colorData
    /// </summary>
    ...
    /// <summary>
    /// This function create a color Array using value from noiseMap and gradient
    /// </summary>
    /// <param name="noiseMap"></param>
    /// <param name="fallOffCondition"></param>
...
```csharp
 /// <summary>
    ...
    /// <summary>
    /// This function load data into CACHE
    /// </summary>
    ...
    /// <summary>
    /// This function convert String to Vector2
    /// </summary>
    ...
    /// <summary>
    /// This function load data into ColorData class
    /// </summary>
    /// <param name="ocean_path"></param>
    /// <returns></returns>
    public ColorData[] GenerateOceanPalete(string ocean_path)
    {
        ...
        {
            MapGenerator.ColorData data = StringToColorData(list[i]);
            ocean[i] = data;
        }
        return ocean;
    }
    /// <summary>
    /// This function convert String to ColorData class
    /// </summary>
    /// <param name="str"></param>
    /// <returns></returns>
    private ColorData StringToColorData(string str)
    {
    ...
    public ColorGrid[] GenerateColorPalete(string biome_path)
    {
        ...
        for (int i = 0; i < colorGrid.Length; i++)
        {
            ...
            {
                MapGenerator.ColorData data = StringToColorData(list[i * colorDatas.Length + k]);
                colorDatas[k] = data;
...
public static class TemperaturGenerator
{
    ...
    /// <summary>
    /// This function create heightMap
    /// </summary>
    /// <param name="width"></param>
    /// <param name="height"></param>
    /// <param name="noiseTemp"></param>
    /// <param name="fallOffMap"></param>
    /// <param name="useFallOff"></param>
    /// <returns></returns>
