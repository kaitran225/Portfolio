...
const HTMLCV: React.FC = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const imageData = canvas.toDataURL('image/jpeg', 0.92); // Use JPEG with 92% quality for better compression
      pdf.addImage(
        imageData,
        'JPEG',
        xOffset,
            ...
            <ContentSection>
              ...
              <ProgrammingSkillsList>
                ...
                <ProgrammingSkillItem>
                  ...
                  <SkillDetails>
                    <SkillDetailLine>7 projects</SkillDetailLine>
                    <SkillDetailLine>3 years</SkillDetailLine>
                  </SkillDetails>
                </ProgrammingSkillItem>
                <ProgrammingSkillItem>
                ...
                <ProgrammingSkillItem>
                  ...
                  <SkillDetails>
                    <SkillDetailLine>2 projects</SkillDetailLine>
                    <SkillDetailLine>2 years</SkillDetailLine>
                  </SkillDetails>
                </ProgrammingSkillItem>
                <ProgrammingSkillItem>
                ...
                <ProgrammingSkillItem>
                  ...
                  <SkillDetails>
                    <SkillDetailLine>3 projects</SkillDetailLine>
                    <SkillDetailLine>1 years</SkillDetailLine>
                  </SkillDetails>
                </ProgrammingSkillItem>
              </ProgrammingSkillsList>
            </ContentSection>
