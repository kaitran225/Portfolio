...
export const LazyHeroSection = lazyWithPreload(() => import('../components/EnhancedHeroSection'));
export const LazyProjectGrid = lazyWithPreload(() => import('../components/ProjectGrid'));
export const LazyContactSection = lazyWithPreload(() => import('../components/ContactSection'));

// Heavy components (load on demand)
export const LazyTerminal = React.lazy(() => import('../components/Terminal'));

// Form components
export const LazyProfessionalContactForm = React.lazy(() => import('../components/ProfessionalContactForm'));

// Development tools
export const LazyPerformanceMonitor = React.lazy(() => import('../components/PerformanceMonitor'));
